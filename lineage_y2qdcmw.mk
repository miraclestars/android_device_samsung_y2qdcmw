...
PRODUCT_BUILD_PROP_OVERRIDES += \
    ...
    PRIVATE_BUILD_DESC="y2qdcmw-user 11 RP1A.200720.012 SC52AOMU1BUC7 release-keys" \
    BUILD_DISPLAY_ID="$(BUILD_ID).SC52AOMU1BUC7" \
    BUILD_NUMBER=SC52AOMU1BUC7 \
    TARGET_BUILD_FLAVOR="y2qdcmw-$(TARGET_BUILD_VARIANT)"

BUILD_FINGERPRINT := "samsung/SC-52A/SC-52A:11/RP1A.200720.012/SC52AOMU1BUC7:user/release-keys"
