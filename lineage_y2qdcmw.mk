...
PRODUCT_BUILD_PROP_OVERRIDES += \
    BUILD_DISPLAY_ID="$(BUILD_ID).SC52AOMU1DWE2" \
    BUILD_NUMBER=SC52AOMU1DWE2 \
    LINEAGE_DEVICE=y2qdcmw \
    PRIVATE_BUILD_DESC="y2qdcmw-user 13 TP1A.220624.014 SC52AOMU1DWE2 release-keys" \
    TARGET_DEVICE=y2q \
    TARGET_PRODUCT=y2qdcmw \
    TARGET_BUILD_FLAVOR="y2qdcmw-$(TARGET_BUILD_VARIANT)"

BUILD_FINGERPRINT := samsung/SC-52A/SC-52A:13/TP1A.220624.014/SC52AOMU1DWE2:user/release-keys
